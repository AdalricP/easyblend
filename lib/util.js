...
export const RESERVED = new Set([
  "api", "manage", "create", "edit", "recover", "spots", "automate", "about",
  "terms", "privacy", "login", "signup", "admin", "blendbox", "_next",
  "favicon.ico", "robots.txt", "sitemap.xml", "static", "assets", "public",
]);
...
export const MAX_LINKS = 10;          // a page can hold at most this many invites
